...
<p align="center">
    <img src="1-Normalizacao.png">
</p>
 
## 2 Normalizações
<p align="center">
    <img src="2-Normalizacao.png">
</p>
 
## 3 Normalizações
<p align="center">
    <img src="3-Normalizacao.png">
</p>
...
CREATE TABLE IF NOT EXISTS `casaoliveiradb`.`funcionario` (
  ...
  `data_nascimento_funcionario` VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`estoque` (
  ...
  `data_entrada` DATE NULL DEFAULT default,
...
CREATE TABLE IF NOT EXISTS `casaoliveiradb`.`pagamento` (
  ...
  `codigo_venda` INT NOT NULL,
  `forma_pagamento` ENUM("Pix", "Débito", "Crédito", "Voucher") NULL,
  `informacao_cartao` VARCHAR(225) NULL,
