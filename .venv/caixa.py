...
# Criar o layout horizontal ---------------------------------------------------------------------------------------
        ...
        self.label_col_esquerda.setStyleSheet("QLabel{background-color:#08A833}")

        self.label_col_direita = QLabel()
        self.label_col_direita.setStyleSheet("QLabel{background-color:#1402FC}")
...
# =============================================================== INICIO DA COLUNA DIREITA =======================================================================

        self.label_col_direita = QLabel()
        self.label_col_direita.setStyleSheet("QLabel{backgroiund-color#ffff66}")


# Criar o layout da coluna da direita para os elementos: QTableWidget, QLabel, QLineEdit ------------------------------------------------------------------------------
        self.layout_vert_col_dir = QVBoxLayout()

        self.tabel_produtos = QTableWidget()
        # Criar os itens do cabeçalho
        ...
        # Adicionar os controles ao layout vertical da col da direita 
        ...
        # Setar o layout vertical na col da direita na coluna da direita 
...
# ================================================================== ADICIONAR OS LAYOUTS NA JANELA ==============================================================
        ...
        # Um evento sera desparado quando você acionar uma tecla
